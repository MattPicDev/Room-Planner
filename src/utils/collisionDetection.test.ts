...
describe('collisionDetection', () => {
  ...
  describe('getFurnitureBounds', () => {
    it('should return correct bounds for non-rotated furniture', () => {
      const bounds = getFurnitureBounds(testFurniture, testTemplate);
    ...
    it('should swap dimensions for 90 degree rotation', () => {
      ...
      const bounds = getFurnitureBounds(rotatedFurniture, testTemplate);
      expect(bounds).toEqual({
        x: 5,
        y: 5,
        width: 2,
  ...
  describe('isPointInFurniture', () => {
    it('should return true for point inside furniture', () => {
      const point = { x: 6, y: 6 };
      const result = isPointInFurniture(point, testFurniture, testTemplate);
    ...
    it('should work correctly with rotated furniture', () => {
      ...
      const point = { x: 6, y: 7 };
      const result = isPointInFurniture(point, rotatedFurniture, testTemplate);
      expect(result).toBe(true);
    });
